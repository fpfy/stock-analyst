...
def main():
    ...
    logger.info("   - 指数数据: ✅ 已验证")
    logger.info("   - 股票信息: ✅ 已验证")
    logger.info("   - 财务数据: ✅ 已验证")
    logger.info("   - 宏观指标: 需修复字段映射")
    logger.info("   - 估值数据: 需修复字段映射")
